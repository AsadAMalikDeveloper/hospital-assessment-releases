...
//                                       .q_id!),
//                                   sid: provider
//                                       .sectionList![provider.selectedIndex].id,
//                                   question: provider
//                                       .sectionList![provider.selectedIndex]
//                                       .questions![index],
//                                   type: provider
...
//                   APIResponse? res = await provider.pickImage(context, aid, qid,
//                       widget.sid!, imageFile.name, imageFile);
//                   if (res!.status!.toLowerCase() == 'success') {
//                     toast.showSuccessToast(res.message ?? "");
...
//                                 aid: widget.aid ?? '',
//                                 // sid: use the provider's current section id
//                                 sid: widget.sid ??
